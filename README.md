...
# 介绍
多年的码农生涯，发现很多时候都是在重复造轮子。突然不想造轮子了，闲的。想封装点东西，让我在开发新的项目的时候能够更快速，更便捷。同时在旧的项目里面也可以无侵入的直接引入使用部份功能。然后simple-common诞生了。
整个项目会先从公共的工具、包、组件开始，慢慢集成为框架。框架可以单体运行，也可快速拆解成微服务，尽量让更多的项目能直接使用，并且过渡公司不同的发展阶段。
...
- 以jwt为核心的登录鉴权一套，借助了点oauth2，目前还不完善，慎用。准备多恶补一下web安全相关的知识，再做升级。
