package com.simple.oauth.common.entity.sysUserLoginKey;
...
@TableName(value = "sys_user_login_key", autoResultMap = true)
@Schema(title = "用户登录标志(sys_user_login_key)实体类")
public class SysUserLoginKey {
