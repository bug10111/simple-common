package com.simple.common.auth.client.broadcast;

import com.simple.common.auth.client.common.broadcast.SecretBroadcaster;
...
@Slf4j
@Component
public class DefaultSecretBroadcaster implements SecretBroadcaster {
